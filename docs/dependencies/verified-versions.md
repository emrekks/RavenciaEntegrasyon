...
| GitHub Setup .NET Action | 6 | `6.0.0` / `a98b56852c35b8e3190ac28c8c2271da59106c68` | <https://github.com/actions/setup-dotnet/releases/tag/v6.0.0> | Action tam commit SHA; SDK girdisi `10.0.302` | `.github/workflows/publish-release-images.yml` | VERIFIED_WORKFLOW_PIN |
| GitHub Setup Node Action | 6 | `6.4.0` / `48b55a011bda9f5d6aeb4c2d9c7362e8dae4041e` | <https://github.com/actions/setup-node/releases/tag/v6.4.0> | Action tam commit SHA; Node girdisi `24.18.1`; otomatik package-manager cache kapalı | `.github/workflows/publish-release-images.yml` | VERIFIED_WORKFLOW_PIN |
| Docker Setup Buildx Action / Buildx | 4 / 0 | `4.2.0` / `bb05f3f5519dd87d3ba754cc423b652a5edd6d2c`; Buildx `v0.34.1` | <https://github.com/docker/setup-buildx-action/releases/tag/v4.2.0> / <https://github.com/docker/buildx/releases/tag/v0.34.1> | Action tam commit SHA, Buildx exact sürüm girdisiyle bağlıdır | `.github/workflows/publish-release-images.yml` | VERIFIED_WORKFLOW_PIN |
