...
| `F3-EV-026` ReferenceRead + webhook release adayı | PASS_IMMUTABLE_RELEASE | `release-2026-08-04-3` / `6cebcba` run `30857610473` başarıyla tamamlandı. Uygulama OCI index digest'i `sha256:1bb0325c63b4ecee95f1ae2b3e7ad1b0e12fd181981752c20db34f9a4e7c1c29`; edge digest'i `sha256:3e35a73cadedd9013a496695147d9d1db0b259c8951b2108c31b989551a4984f`. Production dağıtımı ve panel `ReferenceRead` tekrar testi henüz yapılmadı; dış yazmalar kapalıdır. |
