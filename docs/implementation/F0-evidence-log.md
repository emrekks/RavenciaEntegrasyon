...
| Hedef AWS Ubuntu Server 26.04 LTS | SSH + hedef runbook salt-okunur kontrolleri | x86_64; 2 vCPU; 8.153.141.248 byte RAM; 80.530.636.800 byte NVMe; root filesystem 76.878.503.936 byte; SSH aktif; repository `main`/`274ad4d`; boş ve izlenmeyen `$password_file;` dosyası kullanıcı onayı olmadan kaldırılmadı | HOST_PROFILE_PASSED / WORKTREE_CLEANUP_PENDING |
...
| Restore/RTO | Hedef PostgreSQL 18.4 + private/Data Protection volume restore (`2026-08-03`) | Production set `20260802T223309Z`; iki SHA-256 kontrolü ve güvenli archive path kontrolü geçti; dış ağa kapalı boş PostgreSQL'e restore; kritik şema `3`, kritik tablo `32`, migration `5`, bootstrap `1`, Owner membership `1`; Data Protection dosyası `2`; ölçülen restore `3 sn`; geçici container/volume'lar temizlendi | PASSED_TARGET / OFF_HOST_PENDING |
