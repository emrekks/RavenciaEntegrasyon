...
| `RISK-EFAT-STATUS-001` | P1 | Giden E-Fatura UUID status yolu public sözleşmede kesin değil | E-Fatura nihai durumu yanlış endpoint ile sorgulanabilir | E-Arşiv status/cancel kodlandı; E-Fatura yolu yalnız exact Stage/SIT evidence ile config edilir | MITIGATED_CODE_EXTERNAL_ENDPOINT_PENDING |
