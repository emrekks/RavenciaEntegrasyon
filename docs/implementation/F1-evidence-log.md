...
| `F1-EV-022` AWS Ubuntu host profili (`2026-08-02`) | HOST_PROFILE_PASS / RUNTIME_PENDING | v3.4 PDF 77 sayfa ve SHA-256 `5A652A...0EC51`; gerçek host Ubuntu 26.04 LTS x86_64, 2 vCPU, 8.153.141.248 byte RAM, 80.530.636.800 byte NVMe aygıt ve 76.878.503.936 byte root filesystem olarak ölçüldü. SSH ve systemd çalışır; Docker/Compose kurulumu, reboot/volume/restore ve x5 yük kanıtı bekliyor. |
