...
| `F1-REQ-010` | Tablo 14; job algoritması; F1 teslimatlar | Job, attempt, inbox ve external-effect tekillikleri; lease/reaper/heartbeat ve stale-token koruması uygulanır. | Duplicate/parallel lease/worker-kill testleri | Infrastructure Jobs + Worker | PostgreSQL 18 | DONE_MODEL_SQL / POSTGRES REVERIFY BLOCKED_RUNTIME |
