...
| Permanent URL contract | CODED_PENDING_STAGE | The protected-read preflight and PDF URL request now use the official `Accept: text/plain` media type; invoice create remains `Accept: application/json`. |
