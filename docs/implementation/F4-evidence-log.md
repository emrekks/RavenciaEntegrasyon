...
| Permanent URL contract | VERIFIED_STAGE | v10.73 source CI `32040768596`, immutable publish `32040993423`, backup `20260817T150421Z` and healthy Ubuntu deployment completed. The no-effect protected read used the official `Accept: text/plain` media type and still returned `401 / EFATURAM_ACCESS_TOKEN_REJECTED`; content negotiation is not the cause. |
