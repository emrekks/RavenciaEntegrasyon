...
export function OrdersPage() {
  ...
  function showBulkNotice(message: string, kind: 'success' | 'error' = 'success') { setBulkNotice(message); setBulkNoticeKind(kind); appendNotification(message, kind); setBulkNoticeVersion(current => current + 1) }
  useEffect(() => {
