...
export function ReturnsPage() {
  ...
  const countFilters: ReturnFilters = { ...returnFilters, status: 'ALL' }
  const countsQuery = useQuery({ queryKey: ['returns', 'counts', countFilters], queryFn: () => loadAllReturns(countFilters), enabled: status !== 'ALL' })
  ...
  const countItems = status === 'ALL' ? items : countsQuery.data?.items ?? []
