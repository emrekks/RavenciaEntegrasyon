...
export function OrdersPage() {
  ...
  const platformOptions = (connections.data?.items ?? [])
    .filter(connection => ['TRENDYOL', 'SHOPIFY'].includes(connection.platformCode) && ['ACTIVE', 'VERIFIED'].includes(connection.status.toUpperCase()))
    .map(connection => ({ value: connection.platformCode, label: connection.displayName || connection.platformCode }))
