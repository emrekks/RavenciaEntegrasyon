...
export function OrdersPage() {
  ...
  useEffect(() => {
    ...
    markShippingLabelPrinted(shippingLabel.item.id, shippingLabel.format)
    setPrintedLabels(new Set(loadPrintedShippingLabels()))
  }, [shippingLabel])
...
function ReturnReferenceRow({ item, order }: { item: ReturnClaim; order: Order | null }) {
  ...
  return <><div className="return-reference-row" role="row">
