...
function connectionTestHelp(item: Connection) {
  ...
  if (item.platformCode === 'SHOPIFY' && item.lastErrorCode === 'SHOPIFY_REQUIRED_READ_SCOPE') return 'Shopify uygulama tokenında read_products, read_inventory, read_orders, read_customers ve read_locations okuma izinlerinin tamamı açık olmalı. İzinleri açtıktan sonra yeni token oluşturup burada şifreli kaydedin.'
