...
export function OrdersPage() {
  ...
  const platformOptions = Array.from(new Set(all.map(item => item.platformDisplayName || item.platformCode).filter(Boolean))).sort((left, right) => left.localeCompare(right, 'tr'))
