...
export function ProductsPage() {
  ...
  async function importProductsFromPlatforms() {
    ...
    try {
      ...
      const query = new URLSearchParams({ full: String(full), newOnly: String(newOnly), existingOnly: String(existingOnly), includeArchived: String(productImportIncludeArchived) })
      ...
      const modeLabel = full ? 'tam katalog taraması' : productImportMode === 'NEW_ONLY' ? 'ekli olmayan ürün' : 'ekli ürün güncelleme'
