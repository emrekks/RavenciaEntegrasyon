...
function Security() {
  ...
  function saveLabelSettings() {
    if (!saveShippingLabelSettings(labelSettings)) {
      setMessage('Kargo etiketi ayarları kaydedilemedi. Tarayıcı depolamasına erişim izni verin.')
      return
    }
    setMessage('Kargo etiketi ayarları kaydedildi.')
  }
