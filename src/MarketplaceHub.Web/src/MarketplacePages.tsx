...
function ShippingLabelModal({ item, format, onClose, inline = false }: { item: Order; format?: ShippingLabelFormat; onClose: () => void; inline?: boolean }) {
