...
function CategoryMappingWorkspace() {
  ...
  function openAdvanced() { const element = document.getElementById('mapping-advanced-tools') as HTMLDetailsElement | null; if (element) { element.open = true; window.setTimeout(() => element.scrollIntoView({ behavior: 'smooth', block: 'start' }), 20) } }
