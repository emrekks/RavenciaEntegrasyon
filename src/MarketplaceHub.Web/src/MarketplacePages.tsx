...
export function OrdersPage() {
  ...
  const ordersQuery = useQuery({ queryKey: ['orders', 'page', filters, pageSize, page, orderCursor], queryFn: () => loadOrderPage(filters, pageSize, orderCursor, page), placeholderData: keepPreviousData, staleTime: 30_000, refetchOnWindowFocus: true })
