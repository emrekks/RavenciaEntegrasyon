...
public interface IMarketplaceSalesService
{
    ...
    Task<ServiceResult<Guid>> EnqueueProductSyncAsync(Guid tenantId, Guid connectionId, bool full, bool newOnly, bool includeArchived, string correlationId, CancellationToken cancellationToken);
