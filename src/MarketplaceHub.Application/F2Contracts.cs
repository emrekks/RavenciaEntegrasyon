...
{
    Task<ServiceResult<IReadOnlyList<ReferenceItemView>>> ListAsync(Guid tenantId, Guid connectionId, string resourceType, string? parentExternalId, CancellationToken cancellationToken);
