...
public sealed record CredentialCommand(string? ApiKey, string? ApiSecret, string? Email = null, string? Password = null, string? AccessToken = null, string? ClientSecret = null);
