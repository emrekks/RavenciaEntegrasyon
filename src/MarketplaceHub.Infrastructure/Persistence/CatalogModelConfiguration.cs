...
internal static class CatalogModelConfiguration
{
    ...
    private static void ConfigureCatalog(ModelBuilder builder)
    {
        ...
        builder.Entity<ProductVariant>(entity =>
        {
            ...
            entity.Property(x => x.Weight).HasPrecision(19, 4); entity.Property(x => x.Width).HasPrecision(19, 4); entity.Property(x => x.Height).HasPrecision(19, 4); entity.Property(x => x.Length).HasPrecision(19, 4); entity.Property(x => x.Desi).HasPrecision(19, 4); entity.Property(x => x.CostPrice).HasPrecision(19, 4);
