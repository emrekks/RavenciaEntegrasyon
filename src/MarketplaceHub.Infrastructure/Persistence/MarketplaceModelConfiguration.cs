...
{
    public static void ConfigureMarketplaceModels(this ModelBuilder builder)
    {
    ...
    private static void ConfigureOrders(ModelBuilder builder)
    {
        ...
        builder.Entity<ShipmentPackage>(entity =>
        {
            ...
            entity.Property(x => x.ExternalPackageId).HasMaxLength(256); entity.Property(x => x.OriginExternalPackageId).HasMaxLength(256); entity.Property(x => x.CreatedBy).HasMaxLength(64); entity.Property(x => x.CargoProviderExternalId).HasMaxLength(256); entity.Property(x => x.CargoTrackingNumber).HasMaxLength(256); entity.Property(x => x.GrossAmount).HasPrecision(19, 4); entity.Property(x => x.DiscountAmount).HasPrecision(19, 4); entity.Property(x => x.NetAmount).HasPrecision(19, 4); entity.Property(x => x.Status).HasConversion<string>().HasMaxLength(32); entity.Property(x => x.RawStatus).HasMaxLength(96); entity.Property(x => x.MarketplaceInvoiceStatus).HasConversion<string>().HasMaxLength(32); entity.Property(x => x.MarketplaceInvoiceRawStatus).HasMaxLength(96); entity.Property(x => x.MarketplaceInvoiceNumber).HasMaxLength(256); entity.Property(x => x.MarketplaceInvoiceUrl).HasMaxLength(2048); entity.Property(x => x.RemoteVersion).HasMaxLength(128); entity.Property(x => x.Version).IsConcurrencyToken();
