...
internal static class F3ModelConfiguration
{
    ...
    private static void ConfigureOrders(ModelBuilder builder)
    {
        ...
        builder.Entity<ShipmentPackage>(entity =>
        {
            ...
            entity.Property(x => x.ExternalPackageId).HasMaxLength(256); entity.Property(x => x.OriginExternalPackageId).HasMaxLength(256); entity.Property(x => x.CargoProviderExternalId).HasMaxLength(256); entity.Property(x => x.CargoTrackingNumber).HasMaxLength(256); entity.Property(x => x.Status).HasConversion<string>().HasMaxLength(32); entity.Property(x => x.RawStatus).HasMaxLength(96); entity.Property(x => x.RemoteVersion).HasMaxLength(128); entity.Property(x => x.Version).IsConcurrencyToken();
