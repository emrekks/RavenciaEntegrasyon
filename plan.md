...
- `1eff785` commit'i `origin/main` üzerinde yayınlandı; responsive düzeltme ve bu denetim kanıtı aynı yayınla sunucuya alındı. `https://panel.ravencia.com/health/ready` HTTP 200 döndü, kök HTML ve güncel JavaScript asset'i HTTP 200 ile alındı; API, worker, Caddy ve PostgreSQL container'ları sağlıklı.
