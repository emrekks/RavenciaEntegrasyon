...
public sealed class RepositoryGuardTests
{
    ...
    [Fact]
    public void F5_web_surface_has_only_approved_routes_and_no_later_phase_menu()
    {
        ...
        foreach (var forbidden in new[] { "/reports", "/operations", "/tenants", "/users", "Hepsiburada", "N11", "Pazarama" }) Assert.DoesNotContain(forbidden, source, StringComparison.OrdinalIgnoreCase);
    }
